                                                       ...
                                                       float deviationParam)
{
    ...
    float perWalkingWithSticks = float(inputData["walkability"]["distribution"]["sticks"]["velocity"]) * deviationParam;
    float perWheelchairs = float(inputData["walkability"]["distribution"]["wheelchairs"]["velocity"]) * deviationParam;
